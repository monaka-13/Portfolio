	...
	return (
		<>
			...
			<div>
				...
				<ul>
					<li>
						<Link href="https://github.com/monaka-13">GitHub</Link>
					</li>
					<li>
						<Link href="https://www.linkedin.com/in/kay-shigenaga-501848342/">LinkedIn</Link>
					</li>
				</ul>
				...
				<h3>Profile</h3>
				<ul>
					<li>💬 Name: Kay Shigenaga (or Keisuke Shigenaga, 重永桂典)</li>
					<li>🏝 Location: Vancouver BC, Canada</li>
					<li>🚀 Visa:
						<ul>
							<li> - Student Visa until Mar 2026</li>
							<li> - Post Graduate Visa until Mar 2027</li>
							<li> - Working Holiday Visa until Mar 2028</li>
						</ul>
					</li>
					<li>👨‍💻 Experience:
						<ul>
							<li> - worked for 4 years as a Web developer and as a Manager in Tokyo</li>
							<li> - currently working as a freelancer</li>
						</ul>
					</li>
					<li>🏫 Education:
						<ul>
							<li> - Douglas College in BC, Canada (Expected Dec 2026)</li>
							<li> - Gakushuin University in Tokyo, Japan (Graduated Mar 2020)</li>
						</ul>
					</li>
					<li>📫 How to reach me:
						<ul>
							<li> - e-mail: kshigenaga5@gmail.com</li>
							<li> - <Link href="https://www.linkedin.com/in/kay-shigenaga-501848342/">LinkedIn</Link></li>
						</ul>
					</li>
				</ul>
				...
				<ul>
					<li>
						...
						<ul>
							...
							<li>- <Link href="https://github.com/monaka-13">and more...</Link></li>
						</ul>
					</li>
					<li>
						Backend
					...
					<li>
						Other
						<ul>
							<li>- Low-Code Platform like OutSystems, Microsoft Power Automate</li>
							<li>- Linux</li>
						</ul>
					</li>
				</ul>
